 ...
 *            x0, v0, and t and prints the value of x0 + v0*t − g*t^2 / 2
 *            whereg is the constant 9.80665. (Note : This value is the
 *            displacement in meters after t seconds when an object is thrown
 *            straight up from initial position x0 at velocity v0 meters per
 *            second.)
 ******************************************************************************/
