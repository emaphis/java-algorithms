 ...
 * Program 1.2.29 - DayOfWeek.java
 *
 * Description: Day of the week.
 * Exercise: Write a program that takes a date as input and prints the day
 *           of the week that date falls on. Your program should accept three
 *           int commandline arguments: m (month), d (day), and y (year).
