 ...
 *  Formula: Uses the Java method StdRandom.uniform() to generate a random number
 *           r between 0.0 (inclusive) and 1.0 (exclusive); then multiplies r by
...
public class RandomInt {
    ...
    public static void main(String[] args) {
        ...
        double r = StdRandom.uniform();   // uniform between 0.0 and 1.0
