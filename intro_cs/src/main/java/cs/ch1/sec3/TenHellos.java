 ...
 *            After initializing the value of i to 4, we enter into a while
 *            loop where we use the value of i in the System.out.println()
 *            statement and increment it each time through the loop. After
 *            printing 10th Hello, the value of i becomes 11 and the loop
 *            terminates.
 ******************************************************************************/
